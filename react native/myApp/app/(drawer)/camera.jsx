...
import Slider from "@react-native-community/slider";export default function CameraScreen(){
  ...
  return (
    <View style={styles.container}>
      ...
      <CameraView zoom={0.5} style={styles.camera} facing={facing} ref={cameraRef} />
